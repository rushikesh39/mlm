...
const transactionSchema = new Schema<ITransaction>(
  {
    ...
    source: {
      type: Number,
      enum: [1, 2, 3, 4, 5, 6, 7, 8], //1->Topup fund request, 2->withdrawal req, 3->fund transfer,  4->"deposit", 5->daily income 6->monthly income, 7->level income, 8->Direct Income,9->admin adjustment
      required: true,
    },
    description: String,
    status: {
